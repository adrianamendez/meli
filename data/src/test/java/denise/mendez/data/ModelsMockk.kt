...
import denise.mendez.data.remote.models.PictureDto
...
val ProductDetailsDtoMockk = ProductDetailDto(
    id = idProductMockk,
    title = "Short Traje De Baño Vcp Garden (0150)",
    pictures = picturesListDtoMockk,
...
val installmentsDtoMockk = InstallmentsDto(
    quantity = 12,
    amount = 100000.0,
    rate = 0.0,
    currencyId = "COP"
...
val addressDtoMockk = AddressDto(
    stateId = "CO-DC",
    stateName = "Bogotá D.C.",
    cityId = "TUxNQ1NBTjMxMzBa",
    cityName = "Usaquén"
...
val shippingDtoMockk = ShippingDto(
    freeShipping = true,
    mode = "me2",
    tags = listOf("fulfillment", "mandatory_free_shipping"),
    logisticType = "fulfillment",
...
val countryDtoMockk = CountryDto(
    id = "CO",
    name = "Colombia"
)
...
val attributesDtoMockk = AttributeDto(
    id = "BRAND",
    name = "Marca",
    valueId = "410",
    valueName = "Van Como Piña",
...
val productListMockk = listOf(productMockk, productMockk, productMockk)

val productDtoMockk = ProductDto(
    id = "MCO611234",
    siteId = "MCO",
    title = "Short Traje De Baño Vcp Garden (0150)",
    price = 100000.0,
    ...
    thumbnail = "http://http2.mlstatic.com/D_771968-MLA48647552133_122021-I.jpg",
    acceptsMercadopago = true,
    installments = installmentsDtoMockk,
    address = addressDtoMockk,
    shipping = shippingDtoMockk,
    sellerAddress = sellerAddressDtoMockk,
    attributes = listAttributesDtoMockk,
    originalPrice = 100000.0,
    categoryId = "MCO1430",
    officialStoreId = 1,
    catalogProductId = "213123",
...
val productListDtoMockk = listOf(productDtoMockk, productDtoMockk, productDtoMockk)

val productSearchedDtoMockk = ProductSearchedDto(
    siteId = "MCO",
    query = "short",
    paging = pagingMockk,
